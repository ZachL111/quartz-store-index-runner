"""Regression checks for the quartz-store-index-runner casebook."""
...
from casebook.harness import assert_expected, quartz_store_index_runner_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(quartz_store_index_runner_summary(), assert_expected())
